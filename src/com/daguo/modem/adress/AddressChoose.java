...
public class AddressChoose extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		landDivideDB = LandDivideDB.getInstance(AddressChoose.this);
		List<LandDivide> landDivide = landDivideDB.queryAddress("superior=?",
				new String[] { "1" });
		...
		shengAdapter = new ArrayAdapter(this,
				R.layout.my_set_addresschoose_listview_item,
				R.id.my_set_adresschoose_textview, sheng);
		shiAdapter = new ArrayAdapter(this,
				R.layout.my_set_addresschoose_listview_item,
				R.id.my_set_adresschoose_textview, shi);
		quAdapter = new ArrayAdapter(this,
				R.layout.my_set_addresschoose_listview_item,
				R.id.my_set_adresschoose_textview, qu);
		...
		mListView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				List<LandDivide> landDivide = landDivideDB.queryAddress(
				...
				List<LandDivide> landDivide_2 = landDivideDB.queryAddress(
						"superior=?", new String[] { code });
