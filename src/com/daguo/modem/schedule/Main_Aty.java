 ...
 * @function 课表首页
 */
public class Main_Aty extends TabActivity {
	...
	private void InitViewPager() {
		...
		Intent intent = new Intent(this, TodayDateRemindAty.class);
		listViews.add(getView("Remind", intent));
		Intent intent2 = new Intent(this, TodayDateScheduleAty.class);
