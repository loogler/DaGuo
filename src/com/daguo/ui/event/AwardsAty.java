...
public class AwardsAty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog=CustomProgressDialog.createDialog(AwardsAty.this, "正在查询领奖记录");
		dialog.show();
		...
		getiv.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (!isGet) {
					getiv.setClickable(true);
					new AlertDialog.Builder(AwardsAty.this)
					...
					getiv.setText("已领取");
					getiv.setClickable(false);
					Toast.makeText(AwardsAty.this, "您已参与活动，快去推荐其他小伙伴加入吧",
							Toast.LENGTH_SHORT).show();
				}
