...
public class Event_AwardsAty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog=CustomProgressDialog.createDialog(Event_AwardsAty.this, "正在查询领奖记录");
		dialog.show();
					...
					if (js.getInt("total") == 0) {
						...
						runOnUiThread(new Runnable() {
							public void run() {
								...
								Toast.makeText(Event_AwardsAty.this,
										"您已参与活动，快去推荐其他小伙伴加入吧",
		...
		getiv.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (!isGet) {
					getiv.setClickable(true);
					new AlertDialog.Builder(Event_AwardsAty.this)
					...
					getiv.setText("已领取");
					getiv.setClickable(false);
					Toast.makeText(Event_AwardsAty.this, "您已参与活动，快去推荐其他小伙伴加入吧",
							Toast.LENGTH_SHORT).show();
				}
