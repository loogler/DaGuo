...
public class Event_News_DetailAty extends Activity {
	Message msg;
	...
	private void loadData() {
		new Thread(new Runnable() {
			public void run() {
				...
				try {
					String url = HttpUtil.QUERY_NEWS + "&rows=11&page=1&id="
							+ id;
					...
					if (aaa != 0) {
						...
						for (int i = 0; i < array.length(); i++) {
							...
							content = array.optJSONObject(i).getString(
									"content");
							img_path = array.optJSONObject(i).getString(
									"img_path");
							img_src = array.optJSONObject(i).getString(
									"img_src");
							menu_id = array.optJSONObject(i).getString(
									"menu_id");
							title = array.optJSONObject(i).getString("title");
							title2 = array.optJSONObject(i).getString("title2");
